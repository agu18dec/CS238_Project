...
class SO2(Material): #Initialize to correct values
    def __init__(self, mol=0):
        super().__init__(
            mol=mol,
            name='SO2',
            density={'s': None, 'l': None, 'g': 0.002926},  # g/cm³ at STP for gas
            polarity=1.63,  # Debye (if applicable, or another measure of polarity)
            temperature=298,  # Standard room temperature in Kelvin
            pressure=101.325,  # Standard atmospheric pressure in kPa
            phase='g',  # Assuming standard room conditions
            molar_mass=64.066,  # g/mol
            color=0.2,  # Colorless, using a placeholder value
            charge=0.0,
...
class SO3(Material): #Initialize to correct values
    def __init__(self, mol=0):
        super().__init__(
            mol=mol,
            name='SO3',
            density={'s': None, 'l': None, 'g':  0.003571},  # g/cm³ for solid
            polarity=0.0,  # Non-polar molecule
            temperature=298,  # Standard room temperature in Kelvin
            pressure=101.325,  # Standard atmospheric pressure in kPa
            phase='g',  # Assuming standard room conditions
            molar_mass=80.066,  # g/mol
            color=0.2,  # Colorless, using a placeholder value
            charge=0.0,
            boiling_point=318.0,  # Kelvin
